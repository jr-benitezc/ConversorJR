package examenmo.com.facci.conversorjb;
...
final String[] datos = new String[]{"DOLAR", "EURO", "PESO MEXICANO"};
    ...
    public void clickConvert(View v){
        ...
        }else
        {
            ...
            Toast.makeText(MainActivityJB.this,"Las opciones elegidas no tiene un factor de conversor", Toast.LENGTH_SHORT).show();
        }
    }
